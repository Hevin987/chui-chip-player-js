...
/* Same as gme_open_data(), but enables multichannel output (where supported). */
BLARGG_EXPORT gme_err_t gme_open_data_multi_channel( void const* data, long size, Music_Emu** out, int sample_rate );
